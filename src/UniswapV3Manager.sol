...
contract UniswapV3Manager is IUniswapV3Manager {
    ...
    function mint(MintParams memory params) public returns (uint256 amount0, uint256 amount1) {
    ...
    function swapSingle(SwapSingleParams memory params) public returns (uint256 amountOut) {
        amountOut = _swap(
            params.amountIn,
            msg.sender,
